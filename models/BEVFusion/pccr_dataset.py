...
class PCCRDataset(Custom3DDataset):
    ...
    TP_METRICS = ("trans_err", "scale_err", "orient_err", "attr_err")
    ErrNameMapping = {
        "trans_err": "mATE",
        "scale_err": "mASE",
        "orient_err": "mAOE",
    ...
    def get_data_info(self, index: int) -> Dict[str, Any]:
        ...
        if self.modality["use_camera"]:
            ...
            for _, camera_info in info["cams"].items():
                data["image_paths"].append(self._resolve_data_path(camera_info["data_path"]))
    ...
    def _load_gt_from_tables(self):
        ...
        table_root = osp.join(self.dataset_root, self.version)
