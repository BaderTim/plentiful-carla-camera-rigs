    ...
    dict(
        ...
        transforms=[
            dict(
                type='DefaultFormatBundle3D',
                class_names=[
                    'car', 'truck', 'bus', 'motorcycle', 'bicycle', 'adult',
                ...
                transforms=[
                    dict(
                        ...
                        class_names=[
                            ...
                            'adult', 'child', 'traffic_light', 'traffic_sign'
                        ],
                        with_label=False),
                    dict(type='Collect3D', keys=['img'])
                ])
...
log_level = 'INFO'
work_dir = './work_dirs/petr_r50dcn_gridmask_p4_800x320_pccr/R1'
load_from = None
resume_from = None
workflow = [('train', 1)]
plugin = True
...
model = dict(
    ...
    pts_bbox_head=dict(
        ...
        bbox_coder=dict(
            ...
            pc_range=[-51.2, -51.2, -6.0, 51.2, 51.2, 6.0],
            max_num=300,
            voxel_size=[0.2, 0.2, 8],
            num_classes=9),
